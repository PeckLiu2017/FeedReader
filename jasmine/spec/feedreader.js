...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('each feed has a effective URL', function () {
          $.each(allFeeds,function () {
            expect($(this).attr('url').length).not.toBe(0);
          })
        });
    ...
    describe('Initial Entries',function () {
         ...
         */
         ...
         it('load at least a single .entry element within the .feed container when the loadFeed function completes its work', function(done) {
